...
function ViewPage() {
    ...
    const suggestionId = params.slug;


    console.log('SuggestionId ID:', suggestionId);
    ...
    useEffect(() => {
        const fetchSuggestion = async () => {
            try {
                const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_API_URL}/suggestions/${suggestionId}`, {
                    headers: {
                ...
                if (res.ok && data.success) {
                    ...
                    console.error("Error fetching suggestion:", data.message || "Unknown error");
                }
            } catch (err) {
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row m-1">
                            <div className="col-12">
                                <h4 className="main-title">suggestion  {slug} </h4>
                                <ul className="app-line-breadcrumbs mb-3">
                                    ...
                                    <li className="active">
                                        <a className="f-s-14 f-w-500" href="#">suggestion {slug}</a>
                                    </li>
                                </ul>
                                            ...
                                            <div className="card security-card-content">
                                                ...
                                                <div className="row card-body">
                                                    <div className="col-12 col-lg-6 m-10-0">
                                                        <div className="card-body card-body-style">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <h6 className="mb-0 text-primary">Suggestion ID</h6>
                                                    ...
                                                    <div className="col-12 col-lg-6 m-10-0">
                                                        <div className="card-body card-body-style">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <h6 className="mb-0 text-danger">Votes Count</h6>
                                                    ...
                                                    <div className="col-12 col-lg-6 m-10-0">
                                                        <div className="card-body card-body-style">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <h6 className="mb-0 text-danger">Up Votes</h6>
                                                    ...
                                                    <div className="col-12 col-lg-6 m-10-0">
                                                        <div className="card-body card-body-style">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                <h6 className="mb-0 text-danger">Down Votes</h6>
                                                    ...
                                                    <div className="col-12 col-lg-6 m-10-0">
                                                        <div className="card-body card-body-style">
                                                            <div className="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <h6 className="mb-0">{new Date(suggestion?.updated_at).toLocaleString()}</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
